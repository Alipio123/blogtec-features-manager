...
class Blogtec_Pricing_Table {
    ...
    public function __construct() {
        ...
        // Check if the pricing table feature is enabled
        $options = get_option('blogtec_features_settings');
        $is_enabled = isset($options['enable_pricing_table']) ? $options['enable_pricing_table'] : 0;
    ...
    public function add_pricing_admin_menu() {
        add_menu_page(
            ...
            'dashicons-editor-table',                                                          // Icon URL (optional)
            3  
        );
    }
